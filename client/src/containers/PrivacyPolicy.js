...
function PrivacyPolicy() {
    return (
      ...
      <h1
      className="text-3xl md:text-5xl font-semibold text-center mb-8"
      >Privacy Policy</h1>
      <p>Last updated: 7-31-2024</p>
      <br />
      <p>
        This Privacy Policy describes how Sanimals (the "Site", "we", "us", or
        "our") collects, uses, and discloses your personal information when you
        visit, use our services, or make a purchase from
        https://sanimals.netlify.app/ (the "Site") or otherwise communicate with
        us (collectively, the "Services"). For purposes of this Privacy Policy,
      ...
      <h2
      className="font-semibold"
      >How We Collect and Use Your Personal Information</h2>
      <p>
      ...
      <h2
      className="font-semibold"
      >What Personal Information We Collect</h2>
      <p>
      ...
      <br />
      <h3 className="font-semibold">Information We Collect Directly from You</h3>
      <p>
      ...
      <br />
      <h3 className="font-semibold">Information We Collect through Cookies</h3>
      <p>
      ...
      <br />
      <h3 className="font-semibold">Information We Obtain from Third Parties</h3>
      <p>
      ...
      <p>
        <ul className="list-disc">
          ...
          <li>
            ...
            message or postal mail, and to show you advertisements for products
            or services. This may include using your personal information to
            better tailor the Services and advertising on our Site and other
            websites.
          </li>
          <li>
      ...
      <p>
        ...
        browser controls. Please keep in mind that removing or blocking Cookies
        can negatively impact your user experience and may cause some of the
      ...
      <p>
        ...
        <ul className="list-disc">
          ...
          <li>
            ...
            services and advertise to you. [[NOTE TO MERCHANT: INSERT THE
            FOLLOWING SENTENCE IF USING SHOPIFY'S AD SERVICES, SUCH AS SHOPIFY
            AUDIENCES]] [For example, we use Shopify to support personalized
            advertising with third-party services]. Our business and marketing
      ...
      <p className="font-semibold">Category of Personal Information:</p>
        <ul className="list-disc">
          <li>
            Identifiers such as basic contact details and certain order and
            account information
      ...
      <p>
        ...
        or security of any information that you make publicly available, or for
        the accuracy, use or misuse of any information that you disclose or
        receive from third parties.
      </p>

      <h2 className="font-semibold">Third Party Websites and Links</h2>
      <p>
      ...
      <br/>
      <h2 className="font-semibold">Children's Data</h2>
      <p>
        ...
        this Privacy Policy, we do not have actual knowledge that we "share" or
        "sell" (as those terms are defined in applicable law) personal
        information of individuals under 16 years of age.
      </p>
      <br />
      <h2 className="font-semibold">Security and Retention of Your Information</h2>
      <p>
        Please be aware that no security measures are perfect or impenetrable,
        and we cannot guarantee "perfect security." In addition, any information
        you send to us may not be secure while in transit. We recommend that you
        do not use unsecure channels to communicate sensitive or confidential
        information to us. How long we retain your personal information depends
        on different factors, such as whether we need the information to
        maintain your account, to provide the Services, comply with legal
        obligations, resolve disputes or enforce other applicable contracts and
        policies.
      </p>
      <br />
