...
function TermsOfService() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p>
        This website is operated by Sanimals. Throughout the site, the terms
        “we”, “us” and “our” refer to Sanimals. Sanimals offers this website,
      ...
      <p>
        ...
        conditions (“Terms of Service”, “Terms”), including thoseadditional
        ...
        including without limitation users who arebrowsers, vendors, customers,
      ...
      <p>
        ...
        bound by these Terms of Service. If you do not agree toall the terms and
        ...
        acceptance is expressly limited to theseTerms of Service.{" "}
      </p>
      <p>
        <br />
      </p>
      <p>
        ...
        to check this page periodically forchanges. Your continued use of or
      ...
      <p>
        ...
        that you are the age of majority in your state or province ofresidence
      ...
      <p>
        ...
        adapt totechnical requirements of connecting networks or devices. Credit
      ...
      <p>
        ...
        any contact on the website through which the service isprovided, without
      ...
      <p>
        ...
        general information only and should not be relied uponor used as the
        ...
        reliance on the material on this site is at your ownrisk.{" "}
      </p>
      <p>
        This site may contain certain historical information. Historical
        information, necessarily, is not current and is provided for your
        reference only. We reserve the right to modify the contents of thissite
      ...
      <p>
        ...
        are subject to return or exchange only according to ourReturn Policy.{" "}
      </p>
      <p>
        We have made every effort to display as accurately as possible the
        colors and images of our products that appear at the store. We cannot
        guarantee that your computer monitor's display of any colorwill be
        accurate.{" "}
      </p>
      <p>
        ...
        We may exercise this right on a case-by-case basis. Wereserve the right
        ...
        anytime without notice, at the solediscretion of us. We reserve the
      ...
      <p>
        ...
        your expectations, or that any errors in the Service will becorrected.{" "}
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        per household or per order. These restrictions may includeorders placed
        ...
        that we make a change to or cancel an order, wemay attempt to notify you
        by contacting the e‑mail and/or billing address/phone number provided at
        the time the order was made. We reserve the right to limit or prohibit
        orders that, in our solejudgment, appear to be placed by dealers,
      ...
      <p>
        ...
        update your account and other information, includingyour email address
      ...
      <p>
        ...
        of any kind and without any endorsement. We shall haveno liability
      ...
      <p>
        ...
        with and approve of the terms on which tools areprovided by the relevant
      ...
      <p>
        ...
        new features and/or services shall also be subject to theseTerms of
        Service.{" "}
      </p>
      <p>
        <br />
      ...
      <p>
        ...
        evaluating the content or accuracy and we do not warrantand will not
      ...
      <p>
        ...
        in connection with any third-party websites. Pleasereview carefully the
        ...
        questions regarding third-partyproducts should be directed to the
        third-party.{" "}
      </p>
      <p>
        <br />
      ...
      <p>
        ...
        suggestions, proposals, plans, or other materials, whetheronline, by
        email, by postal mail, or otherwise (collectively, 'comments'), you
        agree that we may, at any time, without restriction, edit, copy,
        publish, distribute, translate and otherwise use in anymedium any
        ...
        any comments; or (3) to respond to anycomments.{" "}
      </p>
      <p>
        ...
        threatening, libelous, defamatory, pornographic, obscene orotherwise
      ...
      <p>
        ...
        other personal or proprietary right. You further agree that yourcomments
        ...
        any way affect the operation of the Service or anyrelated website. You
        ...
        any comments. You are solelyresponsible for any comments you make and
      ...
      <p>
        ...
        information or cancel orders if any informationin the Service or on any
      ...
      <p>
        ...
        pricing information, except as required by law. No specifiedupdate or
      ...
      <p>
        ...
        unlawful purpose; (b) to solicit others to perform orparticipate in any
        ...
        upon or violate our intellectualproperty rights or the intellectual
        ...
        beused in any way that will affect the functionality or operation of the
        Service or of any related website, other websites, or the Internet; (h)
        to collect or track the personal information of others;(i) to spam,
        ...
        features of the Service or any relatedwebsite, other websites, or the
      ...
      <p>
        ...
        delivered to you through the service are (except as expresslystated by
        ...
        implied, including all implied warranties orconditions of
        merchantability, merchantable quality, fitness for a particular purpose,
        durability, title, and non-infringement.{" "}
      </p>
      <p>
        In no case shall Sanimals, our directors, officers, employees,
        affiliates, agents, contractors, interns, suppliers, service providers
        or licensors be liable for any injury, loss, claim, orany direct,
        ...
        savings, loss of data, replacement costs, orany similar damages, whether
        ...
        procured using the service, orfor any other claim related in any way to
        your use of the service or any product, including, but not limited to,
        any errors or omissions in any content, or any loss or damage of any
        kind incurred as aresult of the use of the service or any content (or
        ...
        orjurisdictions do not allow the exclusion or the limitation of
      ...
      <p>
        You agree to indemnify, defend and hold harmless Sanimals and our
        ...
        out of your breach of these Termsof Service or the documents they
      ...
      <p>
        ...
        be enforceable to the fullest extent permitted byapplicable law, and the
        ...
        enforceability of any other remainingprovisions.{" "}
      </p>
      <p>
        <br />
      </p>
      ...
      <p>
        ...
        terminate this agreement at any time without noticeand you will remain
      ...
      <p>
        ...
        agreement and understanding between you and us and govern youruse of the
        ...
        us (including, but not limited to, any prior versions ofthe Terms of
        Service).{" "}
      </p>
      <p>
      ...
      <p>
        ...
        changes to our website. It is your responsibility to check ourwebsite
