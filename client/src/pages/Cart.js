                                ...
                                <tbody key={item.id} className="whitespace-nowrap divide-y">
                                    <tr>
                                        <td className="py-6 px-4">
                                            <div className="flex flex-col md:flex-row md:items-center gap-6 w-full">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm font-normal text-[#333]">Size: {item.size}</p>
                                                    <p className="text-sm font-normal text-[#333]">Color: {item.color}</p>
                                                    <p className="text-sm font-normal text-[#333]">Price: ${(item.price / 100).toFixed(2)}</p>
                                                    <Link 
                                                    href="#"
                                                    color="danger"
                                        ...
                                        <td className="hidden md:block py-6 px-4">
                                            <h4 className="text-md font-bold text-[#333]">${((item.price * item.quantity)/100).toFixed(2)}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            ))}
